...
//					{
						...
						*(ptr+1) = '0';//修改层号
						buflen = end - start+1;
						HAL_UART_Transmit(&UartHandle[0], (uint8_t *)start, buflen, 0xFFFFFFFFU);
						HAL_UART_Transmit(&UartHandle[1], (uint8_t *)start, buflen, 0xFFFFFFFFU);
						HAL_UART_Transmit(&UartHandle[2], (uint8_t *)start, buflen, 0xFFFFFFFFU);
						HAL_UART_Transmit(&UartHandle[3], (uint8_t *)start, buflen, 0xFFFFFFFFU);
						HAL_UART_Transmit(&UartHandle[4], (uint8_t *)start, buflen, 0xFFFFFFFFU);
